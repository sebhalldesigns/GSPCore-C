...
var ASM_CONSTS = {
  66244: ($0) => { var button = $0; button.innerHTML = "Pressed"; },  
 66295: () => { var button = document.createElement("button"); button.innerHTML = "Click me"; button.onclick = function() { Module.ccall("ButtonClickCallback"); }; document.body.appendChild(button); return button; }
};
